...
}
{
	...
	\top \Rightarrow  
	% (P \Rightarrow   Q)
	\rvalL_1 \leq \pi_1(\varx_2) \leq \rvalR_1 
	\land 
	\rvalL_2 \leq \pi_1 (\varx_1) \leq \rvalR_2
	\land
	e^{-\epsilon} \leq 
...
% \begin{lem}[]
% \label{lem:xisLameq}
% Given the environment $\trsenv_1 = [\varu_1 \to (\fvalv_1, \rvalv_1, \rvalv_1)]$, $\trsenv_1 = [\varu_2 \to (\fvalv_2, \rvalv_2, \rvalv_2)]$ and $f(a) + 1 = f(a')$, if 
% \begin{itemize}
% 	\item $\fvalv < 0$, 
% 	$e^{\epsilon 
...
% then we have:
% 	\[
% 	\pi_1(\sem{\varx_1 = f(a) + \frac{1}{\epsilon}\ln(\varu_1)}_{\trsenv_1}(\varx_1))
% 	\lameq 
% 	\pi_1(\sem{\varx_2 = f(a') + \frac{1}{\epsilon}\ln(\varu_2)}_{\trsenv_2}(\varx_2))	
% 	\]	
% \end{lem}
