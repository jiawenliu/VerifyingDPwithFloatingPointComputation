...
}
{
	...
	: \pi_1(\vary_1 \langle 1 \rangle) \lameq 
	\pi_1 (\vary_2 \langle 2 \rangle)
	\Rightarrow 
	\pi_1 (\varx_2 \langle 2 \rangle) = \pi_1 (\varx_1 \langle 1 \rangle)
}~\textbf{round}
% \and
...
% 	: (B \leq \pi_1 ( \vary_2 \langle 2 \rangle))
% 	\land 
% 	(B \leq \pi_1 ( \vary_2 \langle 2 \rangle))
% 	\Rightarrow 
% 	\pi_1 (\varx_2 \langle 2 \rangle) = \pi_1 (\varx_1 \langle 1 \rangle) = B
% }~\textbf{clamp}_r
% \and
% \inferrule
% {
...
% 	\sim_{0} 
% 	\varx_2 = \clamp_B{(\vary_2)}
% 	: ( \pi_1 ( \vary_2 \langle 2 \rangle) \leq -B)
% 	\land 
% 	( \pi_1 ( \vary_2 \langle 2 \rangle) \leq -B )
% 	\Rightarrow 
% 	\pi_1 (\varx_2 \langle 2 \rangle) = \pi_1 (\varx_1 \langle 1 \rangle) = -B
...
for any $\rvalL_1, \rvalL_2, \rvalR_1, \rvalR_2 \in \real$ s.t. 
$	\rvalL_1 \neq 0 \land \rvalL_2 \neq 0 \land \rvalR_1 \neq 0 \land \rvalR_2 \neq 0
	\land 
	e^{-\epsilon} \leq 
	\frac{\rvalL_1}{\rvalL_2}
...
%
where
	$R = \{(\fval_1, \fval_2) \in \float \times \float 
		~|~
...
%
Let $\edistr_1 = \muniform(0, 1]$ and $\edistr_2 = \muniform(0, 1]$, it is enough to show 
...
\\
%
Let $\epsilon' = \epsilon + \ln(\frac{\rvalL_2}{\rvalR_2})$ and 
