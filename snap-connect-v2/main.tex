...
\\
%
Let $\epsilon' = \epsilon + \ln(\frac{\rvalL_2}{\rvalR_2})$ and $\mu_L, \mu_R \in \distr((\float \times \real \times \real) \times (\float \times \real \times \real))$ be the two witness distribution s.t.:
\[
	{\mu_L}(x, y) = 
	\begin{cases}
...
\]
We also have:
$e^0 < \frac{\rvalR_2}{\rvalL_2} \leq e^{3\eta B}$.
\\
Then, we have following derivation for this case:
...
\[
	e^0 < \frac{\rvalR_1 - \rvalL_1}{\rvalR_2 - \rvalL_2}
	\leq e^{\epsilon(12 \eta B + 1)} < e^{\epsilon(23 \eta B + 1)}.
\]
%
...
%
	...
	\[
		e^0 < \frac{\rvalR_1 - \rvalL_1}{\rvalR_2 - \rvalL_2}
		\leq e^{\epsilon(14 \eta B + 1)} < e^{\epsilon(23 \eta B + 1)}.
	\]
	%
	We also have:
	$e^0 < \frac{\rvalR_2}{\rvalL_2} \leq e^{3\eta B}$.
