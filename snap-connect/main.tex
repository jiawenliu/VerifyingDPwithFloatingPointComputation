...
\label{fig:aprhl}
\end{figure}
The judgment $\vdash: \prog^1 \sim_{\epsilon, \delta} \prog^2: \Phi_0 \Rightarrow \Phi$ is read as, given two environments $\trsenv_0^1$ and $\trsenv_0^2$ satisfying precondition $\Phi_0$, 
then under the semantics definition, 
$(\sem{\prog^1}_{\trsenv_0^1})$ 
$\sem{\Phi}^{\#(\epsilon, \delta)}$ 
$(\sem{\prog^2}_{\trsenv_0^2})$.
