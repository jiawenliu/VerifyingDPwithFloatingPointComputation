...
However, these verifications are under the assumption that implementation of these algorithms are over real computing without computation error.
While in reality, these algorithms are mostly implemented in floating point computation with computation errors.
These computation errors can cause severs failure in preserving differential privacy.
%
