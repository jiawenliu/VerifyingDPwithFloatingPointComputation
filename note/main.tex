...
{
	y_1 = \frac{\ln(u_1)}{\epsilon} \sim_{0, 0} y_2 = \frac{\ln(u_2)}{\epsilon} : u_1 = e^{\epsilon} u_2  \Rightarrow y_2 - 1 \leq y_1 \leq 1 + y_2
}
\\\\
\inferrule
{
...
\[
	{\mu_L}(x, y) = 
	\begin{cases}
	{\uniform}(x) & (x,y) \in \Psi \land x \in [0, 1)\\
	0       & o.w.
	\end{cases}
	\\
	{\mu_R}(x, y) = 
	\begin{cases}
	{\uniform}(y) & (x,y) \in \Psi \land y \in [0, 1)\\
	0       & o.w.
	\end{cases}.
\]
