...
\begin{definition}[Span on measurable spaces]
  Let $A,B$ and $R$ be measurable spaces, a \emph{span} from is a 5-places relation $(A,B,R,\rho_1,\rho_2)$ such that  $\rho_1:R\to A$ and $\rho_2: R\to B$.   
\end{definition}

\begin{definition}[Approximate span-lifting]
  ...
  where
  $$
  W(\epsilon, \delta)=\{(\mu_L,\mu_R)\in \distr(R)\times\distr(R)\|\ \Delta_\epsilon(\mu_L,\mu_R)\leq \delta\}
  $$
