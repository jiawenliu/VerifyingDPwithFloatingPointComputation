...
%
	...
	Because $\Lambda$ is the greatest power of 2 where $\Lambda \leq \frac{1}{\epsilon}$ and $\Lambda < 1$, we have $\epsilon > 1$.
	From this, we can conclude: $(e^{-1}, e^1) \subset (e^{-\epsilon}, e^{\epsilon})$, i.e.:
	%
