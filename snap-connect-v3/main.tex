...
\\
$\Phi \triangleq \rvalL_1 \leq u^1_1\langle 1 \rangle \leq \rvalR_1 \imply 
		\rvalL_2 \leq u^1_2\langle 2 \rangle \leq \rvalR_2$
\\
$\Phi' \triangleq 0 \leq \Big(f(a) + \frac{1}{\epsilon}\ln(u_1)\Big)^1 \leq b + \frac{\Lambda}{2} 
\imply 
0 \leq \Big(f(a') + \frac{1}{\epsilon}\ln(u_2) \Big)^1 \leq b + \frac{\Lambda}{2} $
%
\\
