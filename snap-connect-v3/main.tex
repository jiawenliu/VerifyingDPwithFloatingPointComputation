...
%
\\
$\sem{\mathcal{A}_1 \land \mathcal{A}_2} = \big\{(\trsmem_1, \trsmem_2)
~|~ (\trsmem_1, \trsmem_2) \in \sem{\mathcal{A}_1} \land 
	(\trsmem_1, \trsmem_2) \in \sem{\mathcal{A}_2} \big\}$
%
\\
$\sem{\mathcal{A}_1 \lor \mathcal{A}_2} = \big\{(\trsmem_1, \trsmem_2)
~|~ (\trsmem_1, \trsmem_2) \in \sem{\mathcal{A}_1} \lor 
	(\trsmem_1, \trsmem_2) \in \sem{\mathcal{A}_2} \big\}$
%
\\
$\sem{\neg \mathcal{A}} = \big\{(\trsmem_1, \trsmem_2)
~|~ (\trsmem_1, \trsmem_2) \notin \sem{\mathcal{A}} \big\}$
%
\\
$\sem{\mathcal{A}_1 \imply \mathcal{A}_2} = \big\{(\trsmem_1, \trsmem_2)
~|~ (\trsmem_1, \trsmem_2) \in \sem{\mathcal{A}_1} \imply 
	(\trsmem_1, \trsmem_2) \in \sem{\mathcal{A}_2} \big\}$
%
\\
$\sem{\forall L \in \mathcal{D}. ~\mathcal{A}} = \big\{(\trsmem_1, \trsmem_2)
~|~ \forall L \in \mathcal{D}. ~ (\trsmem_1, \trsmem_2) \in \sem{\mathcal{A}} \big\}$
%
\\
$\sem{\exists L \in \mathcal{D}. ~\mathcal{A}} = \big\{(\trsmem_1, \trsmem_2)
~|~ \exists L \in \mathcal{D}. ~ (\trsmem_1, \trsmem_2) \in \sem{\mathcal{A}} \big\}$
%
%
%
\paragraph{Judgment.}
...
\\
%
Let $\mu_L, \mu_R \in \distr\left((0,1]^{\float} \times (0,1]^{\float}\right)$ 
