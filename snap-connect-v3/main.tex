	...
	By definition of $\epsilon-$DP divergence, we have:
	 ...
	 \begin{itemize}
		...
		\[
		 ...
		 \Delta_{\epsilon}(\mu_L, \mu_R) 
		 & = 
		 \sum_{(x,y) \in S} \pdf_{\uniform}(x) - e^{\epsilon} \sum_{(x,y) \in S} \pdf_{\uniform}(y)\\
		 & = 
		 \sum_{(x,y) \in S} \pdf_{\uniform}(x) - e^{\epsilon} \sum_{(x,y) \in S} \pdf_{\uniform}(x * e^{-\epsilon})\\ 
		 & = 
		 \sum_{(x,y) \in S} \pdf_{\uniform}(x) - e^{\epsilon}* e^{-\epsilon} \sum_{(x,y) \in S} \pdf_{\uniform}(x) 
		 = 0 
		 \end{array}
		 \]
		 %
		 ...
		 \Delta_{\epsilon}(\mu_L, \mu_R) 
		 = 
		 0 - e^{\epsilon} \sum_{(x,y) \in S} \pdf_{\uniform}(y) <0
		 \]
	 	\item[{\bf case}] o.w.:
	 	%
		 \[
