...
\[
	\pdf_{\mu_L}(x, y) = 
	\begin{cases}
	\pdf_{\edistr_1}(x) & x = y \cdot e^{-\epsilon} \land x \in [0, 1)\\
	0       & o.w.
	\end{cases},
~~~
	\pdf_{\mu_R}(x, y) = 
	\begin{cases}
	\pdf_{\edistr_2}(y) & x = y \cdot e^{-\epsilon} \land y \in [0, 1)\\
	0       & o.w.
	\end{cases}.
\]
...
\inferrule
{
	...
	\inferrule
	{
		...
		{	\varu_1 \samplel \uniform(0,1)
			...
			\top
			\Rightarrow 
			\rvalL \leq u^1_1 \leq \rvalR \imply 
			e^{\epsilon(1 + \eta)^2}\rvalL \leq u^1_2 \leq e^{\epsilon(1 + \eta)^2}\rvalR
		}~\textbf{unif}
		\\ 
		\top \Rightarrow \top
		\and
		...
		(e^{\epsilon(1 + \eta)^2}\rvalL \leq u^1_2 \leq e^{\epsilon(1 + \eta)^2}\rvalR)
		\Rightarrow
		\rvalL_1 \leq u^1_1 \leq \rvalR_1 \imply 
		\rvalL_2 \leq u^1_2 \leq \rvalR_2
	}
	{
		\varu_1 \samplel \uniform(0,1)
		\sim_{\epsilon(1 + \eta)^2} 
